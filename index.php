<?php
$typework = ["FrontEnder","Footballer","Sobacher"];
$datestart = ["15 Feb 2019","Mar 2022","Dec 2021"];
$dateend = ["20 Avg 2020","2022","по настоящий момент"];
$jobdescription = ["Владение React","Proffesional","Очень большой любитель собачек"];
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
          <?php for ($i = 0; $i < count($typework); $i++):?>
            <h5 class="w3-opacity"><b><?php echo $typework[$i];?></b></h5>
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
              <?php echo $datestart[$i];?> - 
              <?php if ($i == 0):?>
              <span class="w3-tag w3-teal w3-round"><?=$dateend[$i];?></span>
              <?php else:?>
              	<?=$dateend[$i];?>
                <?php endif;?>
              </h6>
            <p><?php echo $jobdescription[$i];?></p>
            <hr>
            <?php endfor;?>
